...
def main():
    ...
    _G, _D, Gs = pickle.load(open('cache/2019-02-10-stylegan-asuka.pkl', "rb"))
    ...
    # Generate video.
    mp4_file = 'results/circular_asuka.mp4'   # todo: přidat timestamp, aby se to nepřepisovalo
    mp4_codec = 'libx264'
    mp4_bitrate = '3M'
    mp4_fps = 20

    audio = moviepy.editor.AudioFileClip('aaron_smith_dancin_krono_remix.mp3')
    frames = frames.set_audio(audio.set_duration(frames.duration))
